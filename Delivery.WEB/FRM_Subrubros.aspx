<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FRM_Subrubros.aspx.vb" Inherits="Delivery.WEB.FRM_Subrubros" %>
...
&nbsp;<span class="auto-style7"><strong>Delivery -SubRubros</strong></span></td>
                </tr>
                <tr>
...
&nbsp;<asp:Button ID="Btn_Paises3" runat="server" BackColor="#E51727" CssClass="auto-style8" ForeColor="White" Height="50px" Text="Paises" Width="200px" />
                ...
                <tr>
                    ...
                    <td class="auto-style17">
                        <asp:TextBox ID="txt_ID_SubRubro" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style3">ID_Rubro</td>
                    <td class="auto-style18">
                        <asp:DropDownList ID="ddl_ID_Rubro" runat="server" DataSourceID="RESTO_DELIBERY" DataTextField="ID_Rubro" DataValueField="ID_Rubro">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="RESTO_DELIBERY" runat="server" ConnectionString="<%$ ConnectionStrings:Conn %>" SelectCommand="SELECT [ID_Rubro] FROM [Rubros]"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style1" colspan="2">&nbsp;<asp:Button ID="btn_Aceptar" runat="server" Text="Aceptar" Width="200px" />
