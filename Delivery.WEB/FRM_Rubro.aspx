<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FRM_Rubro.aspx.vb" Inherits="Delivery.WEB.FRM_Rubro" %>
...
&nbsp;<span class="auto-style7"><strong>Delivery -Rubros</strong></span></td>
                </tr>
                <tr>
...
&nbsp;<asp:Button ID="Btn_Paises3" runat="server" BackColor="#E51727" CssClass="auto-style8" ForeColor="White" Height="50px" Text="Paises" Width="200px" />
                ...
                <tr>
                    ...
                    <td class="auto-style17">
                        <asp:TextBox ID="txt_ID_Rubro" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
